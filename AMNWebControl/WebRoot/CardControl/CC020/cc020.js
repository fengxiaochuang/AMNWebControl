   ...
   try{
	   ...
	   dataLayout= $("#dataLayout").ligerLayout({ allowBottomResize: false, allowLeftResize: false });
       	...
       	dataGrid=$("#dataGrid").ligerGrid({
            ...
            {display:'门店名称', name:'attr2', width:150, align:'left'},
            {display:'日期范围', name:'attr3', width:150,  align:'right'},
            {display:'支付宝金额', name:'attr4', width:150, align:'right',totalSummary:
            {
                type: 'sum'
            }},
            {display:'微信金额', name:'attr5', width:150, align:'right',totalSummary:
            {
                type: 'sum'
            }},
            {display:'OK卡金额', name:'attr6', width:150, align:'right',totalSummary:
            {
                type: 'sum'
            }},
            {display:'东方购物金额', name:'attr7', width:150, align:'right',totalSummary:
            {
                type: 'sum'
            }}],
            pageSize:50, 
