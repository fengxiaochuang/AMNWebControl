		...
		<div class="l-loading" style="display:block" id="pageloading"></div> 
	  	<div id="cc011layout" style="width:100%; margin:0 auto; margin-top:4px; "> 
			 <div position="center"   id="designPanel"  style="width:100%;" > 
				...
				<div id="keysList" style="z-index:2;width:350px;position:absolute;display:block;background:#FFFFFF;border: 2px solid #a4a6a1;font-size:13px;cursor: default;" onblur> </div>
...
// 	document.write("<div id=\"keysList\" style=\"z-index:2;width:350px;position:absolute;display:block;background:#FFFFFF;border: 2px solid #a4a6a1;font-size:13px;cursor: default;\" onblur> </div>");
