...
//---------------------------------------------回车事件
		...
		function dis2015()
		{
			...
			{
				var row =commoninfodivdetial.records[rowid];
				commoninfodivdetial.updateRow(rowid,{changebyaccountamt:ForDight((row["changeproamt"]*1-row["changebycashamt"]*1)*lvl,1),changebyproaccountamt:0,changebysendaccountamt:0,changebyfaceamt:0});
			}
		}
